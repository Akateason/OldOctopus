...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EllipsePageControl/EllipsePageControl.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MSDynamicsDrawerViewController/MSDynamicsDrawerViewController.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIFontWDCustomLoader/UIFontWDCustomLoader.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/XTBase/XTBase.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XTColor/XTColor.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XTFMDB/XTFMDB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XTIAP/XTIAP.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XTReq/XTReq.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XTRouter/XTRouter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XTTable/XTTable.framework"
