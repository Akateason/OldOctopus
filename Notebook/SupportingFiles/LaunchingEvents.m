...
//  Upload default items .
    [[XTCloudHandler sharedInstance] saveList:@[book.record]
     //cdn图片丢失 //@[book.record,noteICloud.record,note.record,notePro.record]
                                   deleteList:nil
                                     complete:^(NSArray *savedRecords, NSArray *deletedRecordIDs, NSError *error) {
