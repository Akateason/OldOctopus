...
#define kCWSCREENWIDTH  [UIView currentScreenBoundsDependOnOrientation].size.width
#define kCWSCREENHEIGHT [UIView currentScreenBoundsDependOnOrientation].size.height
